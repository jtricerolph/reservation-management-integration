 ...
 * Description: Displays hotel room bookings in a table format organized by date and floor using shortcode [hotel-table-bookings-by-date]
 * Version: 1.1.15
 * Author: Your Name
 * Author URI: https://yourwebsite.com
 * License: GPL v2 or later
 * License URI: https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain: hotel-booking-table
 */
...
class Hotel_Booking_Table {
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <p>Use the following shortcode in any page or post:</p>
            <code>[hotel-table-bookings-by-date]</code>
            <p>Or specify a custom hotel ID:</p>
            <code>[hotel-table-bookings-by-date hotel_id="1"]</code>
    ...
    private function call_api($action, $data = array()) {
        ...
        if (empty($username) || empty($password) || empty($api_key)) {
            $error_msg = 'API credentials not configured. Please go to Settings > Hotel Booking Table';
            error_log('Hotel Booking Table: ' . $error_msg);
