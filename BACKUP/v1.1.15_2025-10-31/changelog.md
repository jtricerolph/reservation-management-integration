# Hotel Booking Table Plugin - Changelog

## Version 1.0.88 (October 2025)
...
### 1. **Improved Suggestion Column Visual Hierarchy** âœ“
...
### 2. **Amber Highlighting for Active Suggestions** âœ“
...
### 3. **Interactive Update Checkboxes** âœ“
...
**Checkbox Features:**
- âœ“ **Checked by default** for all suggestions
...
### 4. **Enhanced Confirm Match Function** âœ“
...
### After v1.0.65:
1. âœ“ Green only on matched data columns (clear distinction)
2. âœ“ Amber only on cells with actual suggestions (better hierarchy)
3. âœ“ Checkboxes allow selective update application
4. âœ“ Version number visible for troubleshooting
...
âœ“ Compatible with all previous API integrations
âœ“ No breaking changes to shortcode or configuration
